...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_layout_json')) {
        Object.defineProperty(Module['ready'], '_layout_json', { configurable: true, get: function() { abort('You are getting _layout_json on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_layout_json', { configurable: true, set: function() { abort('You are setting _layout_json on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_free_json')) {
        Object.defineProperty(Module['ready'], '_free_json', { configurable: true, get: function() { abort('You are getting _free_json on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_free_json', { configurable: true, set: function() { abort('You are setting _free_json on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'dagre_fast.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('dagre_fast.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _layout_json = Module["_layout_json"] = createExportWrapper("layout_json");

/** @type {function(...*):?} */
var _malloc = Module["_malloc"] = createExportWrapper("malloc");

/** @type {function(...*):?} */
var _free_json = Module["_free_json"] = createExportWrapper("free_json");
